...
" Cursor
hi CursorColumn ctermbg=251 cterm=none guibg=#C6C6C6 gui=none
hi CursorLine ctermbg=251 cterm=none guibg=#C6C6C6 gui=none
...
hi ShowTrailingWhitespace ctermbg=248 guibg=#A8A8A8
